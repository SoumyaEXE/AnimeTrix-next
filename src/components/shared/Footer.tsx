...
const socialMediaLinks = [
    {
        icon: <Github />,
        url: "https://github.com/SoumyaEXE/AnimeTrix-next",
    },
    {
        icon: <Instagram />,
        url: "https://www.instagram.com/s0umy4_xD/",
    },
];
